...
RUN \
    yum install -y redhat-lsb-core git make deltarpm zlib-devel.x86_64 boost-devel.x86_64 boost-static fuse-devel.x86_64 glibc-devel.x86_64 cmake gcc systemd-devel boost-system boost-program-options gcc-c++ && \
